        ...
        <div className="payment">
            ...
            <div className="w-screen ml-0 h-[650px] relative ">
                <div className="w-screen h-[100%] bg-midnight-blue">
                    ...
                    <div className="w-[100%] h-[100%] absolute z-[4] flex justify-center items-start left-0 top-[30px]">
                        <div className="h-[580px] w-[450px] bg-main-white z-[4] absolute rounded-[10px] opacity-30">
                        </div>
                    </div>
                    <div className="w-[100%] h-[100%] absolute z-[5] flex justify-center items-start left-0 top-[100px]">
                        <form className="w-[300px] h-[300px] absolute">
                            ...
                            <div className="flex justify-between items-center">
                                <input
                                    ...
                                    placeholder="Date"
                                    name="date"
                                    className="w-[90px] h-[50px] p-[10px] rounded-[7px] border-none bg-[#161A27]
                                    mt-[30px] outline-none text-main-white placeholder:text-[13px]"/>
                                <input
                                    type="text"
                                    placeholder="CVC"
