 ...
 function Movie({ url, name}) {
    return (
            <div className="group ml-[30px] relative overflow-hidden">
                ...
                />
                <div className="absolute h-[120px] w-[202px] bottom-0 left-0 2xl:left-[40px]
                flex flex-col items-center opacity-0 group-hover:opacity-100 group-hover:translate-y-[-40px]
